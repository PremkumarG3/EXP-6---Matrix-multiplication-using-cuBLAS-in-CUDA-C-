...
<h3>ENTER YOUR NAME: Prem Kumar G</h3>
...
```
# OUTPUT:
<img width="1210" height="312" alt="image" src="https://github.com/user-attachments/assets/e949d647-194b-4693-a597-48fb497f2ad8" />

# RESULT:

Thus, the matrix multiplication has been successfully implemented using the cuBLAS library in CUDA C, demonstrating the enhanced performance of GPU-based computation over CPU-based approaches was executed successfully.
